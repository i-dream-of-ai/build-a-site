...
import { UserUpdates, User } from '@/types/user';
...
export const AccountForm: React.FC<AccountFormProps> = ({ user }) => {
    ...
    const { data: userData, isLoading, isError } = useUserProfile(user?._id, user !== undefined);
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        updateUserMutation.mutate({ id: user._id, updates: formState as UserUpdates});
    };
