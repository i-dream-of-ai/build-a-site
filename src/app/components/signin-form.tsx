    ...
    <div>
      ...
      <div className='mb-8'>
        ...
        <p className="mt-2 text-sm leading-6 text-gray-300">
          Not a member?{' '}
          <Link href="/register" className="font-semibold text-indigo-300 hover:text-indigo-500">
            Register Here
          </Link>
        </p>
      </div>
      ...
      <form onSubmit={submit} method="POST" className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            />
            <label htmlFor="remember-me" className="ml-3 block text-sm leading-6 text-purple-400">
              Remember me
            </label>
          </div>

          <div className="text-sm leading-6">
            <a href="#" className="font-semibold text-purple-400 hover:text-purple-500">
              Forgot password?
            </a>
          </div>
        </div>
