    ...
    body: JSON.stringify({
      ...
      messages: [
        ...
        },
        {
          role: 'system',
          content:
            'Do not answer questions about anything other that creating a website. Once you have the information you need, generate the site. Do not ask more questions.',
        },
        ...messages,
      ],
