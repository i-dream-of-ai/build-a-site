            ...
            <form className='w-full mx-auto' onSubmit={initAiMessage}>
              <div className="space-y-12">
                <div className="border-b border-purple-500/10 pb-12">
                  <h2 className="text-base font-semibold leading-7 text-neutral-300">Get Started</h2>
                  ...
                  <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div className="sm:col-span-6">
                      <label htmlFor="title" className="block text-sm font-medium leading-6 text-neutral-300">
              ...
              <button type='submit' className='py-2 px-4 rounded-md flex items-center justify-center bg-purple-600 cursor-pointer hover:bg-purple-700 text-white'>Get Started</button>
            </form>
          </div>  
        )}
      </div>
